...
function DepositedByContributorTable({ data }) {
  ...
  return (
    <div
      ...
      <table style={{ width: "100%", color: "#fff" }}>
        <thead>
          <tr>
            <th style={{ background: "#333", padding: 4 }}>Contributor</th>
        ...
        <tbody>
          {data.map((row, i) => (
            <tr key={i}>
              <td style={{ padding: 4 }}>{row["Contributor"]}</td>
              <td style={{ padding: 4 }}>
...
export default DepositedByContributorTable;
